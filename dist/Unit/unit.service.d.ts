...
export declare class UnitService {
    ...
    createUnit(createUnitDto: CreateUnitDto): Promise<import("mongoose").Document<unknown, {}, Unit> & Omit<Unit & Required<{
        _id: import("mongoose").Types.ObjectId;
    }>, never>>;
    editUnit(editUnitDto: ChangeUnitDto): Promise<import("mongoose").Document<unknown, {}, Unit> & Omit<Unit & Required<{
        _id: import("mongoose").Types.ObjectId;
    }>, never>>;
    deleteUnit(deleteUnitDto: {
        id: string;
    }): Promise<import("mongoose").Document<unknown, {}, Unit> & Omit<Unit & Required<{
        _id: import("mongoose").Types.ObjectId;
    }>, never>>;
    getUnits(getUnitsDto: GetUnitsDto): Promise<{
        totalPages: number;
        currentPage: number;
    ...
    test(): Promise<(import("mongoose").Document<unknown, {}, Unit> & Omit<Unit & Required<{
        _id: import("mongoose").Types.ObjectId;
    }>, never>)[]>;
    getPrintUnits(getPrintUnitsDto: GetPrintUnitsDto): Promise<(import("mongoose").Document<unknown, {}, Unit> & Omit<Unit & Required<{
        _id: import("mongoose").Types.ObjectId;
    }>, never>)[]>;
