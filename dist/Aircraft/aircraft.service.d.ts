...
export declare class AircraftService {
    ...
    constructor(aircraftModel: Model<Aircraft>, engineModel: Model<Engine>, apuModel: Model<Apu>, limitModel: Model<Limit>, gearModel: Model<Gear>);
    add(createAircraftDto: CreateAircraftDto): Promise<import("mongoose").Document<unknown, {}, Aircraft> & Omit<Aircraft & Required<{
        _id: import("mongoose").Types.ObjectId;
    }>, never>>;
    getAircrafts(): Promise<Omit<import("mongoose").Document<unknown, {}, Aircraft> & Omit<Aircraft & Required<{
        _id: import("mongoose").Types.ObjectId;
    }>, never>, never>[]>;
